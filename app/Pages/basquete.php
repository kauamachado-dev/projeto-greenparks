...
<head>
    ...
    <link href="../View/css/basquete.css" rel="stylesheet">
</head>
<body>
    ...
    <section class="container">
        <div id="titulo1">BASQUETE</div>
    </section>
    <div class="linha1"></div>
    <img id="basquete" src="../View/css/images/basquete.jpg">
    <div class="basquetetxt">
            <P>Venha participar das aulas de basquete!</P>
            <P>Local: Rua Luís Burgin - Violim</P>
            <P>Horário: das 15:30hrs ás 16:45hrs </P>
            </div>
    <div class="linha2"></div>
    <div class="databsqt">
            <P>Terças a quintas-feiras!</P>
