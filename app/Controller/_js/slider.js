let time2 = 4000, //tempo de troca de imagem
...
function nextImage_2() {
    ...
    images2[currentImageIndex2].classList.remove("selectedau")//remove a imagem que estiver com "class =  selected"
    ...
    images2[currentImageIndex2].classList.add("selectedau")//mostra a nova imagem com "class = selected"
}
